...
export default class Simon extends Component {
  ...
  simonAI () {
    ...
    while (moveCounter <= this.state.moveCount) {
      let ranNum = Math.floor(Math.random() * 4 + 1)

      this.handleGameboardClick(ranNum)
      ...
      <div
        ...
        <div>
          <svg className='simon-gameboard-wrapper'>
            <path
              onClick={this.handleGameboardClick.bind(this, 1)}
            ...
            />
            <path
              onClick={this.handleGameboardClick.bind(this, 2)}
            ...
            />
            <path
              onClick={this.handleGameboardClick.bind(this, 3)}
            ...
            />
            <path
              onClick={this.handleGameboardClick.bind(this, 4)}
          ...
          <span className='simon-scoreboard'>{this.state.gameInProgress ? this.state.moveCount : '- -'}</span>
        </div>
      </div>
