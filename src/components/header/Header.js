  ...
  render () {
    ...
    return (
      <div className='header'>
        <div className='icon'>
          <a href='http://arjohnston.io'>
            <Icon />
          </a>
        </div>

        <div className='title'>
          <a href='http://arjohnston.io'>arjohnston.io</a>
          <span> / </span>
          <Link className='button' to='/'>
            projects
          </Link>
          {title}
          <Link className='button' to={'/' + this.props.title}>
            {this.props.title}
          </Link>
        </div>
      </div>
